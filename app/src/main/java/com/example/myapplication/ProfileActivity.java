    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        settings.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Retrieve the profile picture path and include it in the intent
                String sessionToken = SharedPreferencesHelper.getSessionToken(getApplicationContext());
                String profilePicturePath = SharedPreferencesHelper.getUserPicturePath(getApplicationContext(), sessionToken);
